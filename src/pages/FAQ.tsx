...
const faqCategories = [
  {
    ...
    items: [
      ...
      { q: "What areas do you serve?", a: "We serve all of Southwest Florida from Tampa to Fort Myers, including Sarasota, Bradenton, Venice, Port Charlotte, Punta Gorda, Cape Coral, Naples, Bonita Springs, Englewood and surrounding areas." },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Can I reserve a specific slab?", a: "Yes! Once you select a slab you love, we can reserve it for you. Contact us at (941) 279-0739 or info@altarstonecountertops.com to hold your slab." },
    ],
  },
  {
    category: "Pricing & Payment",
    items: [
      { q: "What is an 'Estimated Investment Range'?", a: "Our online estimate tool gives you a realistic price range based on your material selection, square footage and services needed. It is not a final quote — after your free in-home consultation, we provide an exact price with no surprises." },
  ...
  },
  {
    ...
    items: [
      { q: "How long does installation take?", a: "Most kitchen countertop installations are completed in 1-2 days. The full process from your first quote to final installation typically takes 1-2 weeks." },
      ...
      { q: "Do you offer a warranty?", a: "Yes. We provide a 1-year labor warranty on all installations, plus the manufacturer warranty on all materials including quartz, marble, quartzite and granite." },
    ],
  },
];
